...
<fieldset>
    <?php if ( $_dff['state'] != 'disabled' ): ?>
        ...
        <input type="text"
               aria-label="<?php echo asp_icl_t( "Post date filter: Content from" . " ($real_id)", $_dfrom_t, true ); ?>"
               placeholder="<?php echo asp_icl_t( "Post date filter placeholder (from)" . " ($real_id)", $style["date_filter_from_placeholder"], true ); ?>"
    ...
    <?php if ( $_dft['state'] != 'disabled' ): ?>
        ...
        <input type="text"
               aria-label="<?php echo asp_icl_t( "Post date filter: Content to" . " ($real_id)", $_dto_t, true ); ?>"
               placeholder="<?php echo asp_icl_t( "Post date filter placeholder (from)" . " ($real_id)", $style["date_filter_to_placeholder"], true ); ?>"
