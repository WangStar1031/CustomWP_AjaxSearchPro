...
<fieldset class="asp_custom_f<?php echo in_array($item->asp_f_type, array('checkboxes', 'radio')) ? ' asp_sett_scroll' : ''; ?>" id="t<?php echo  $y_in* 4 + 2; ?>">
<?php endif; ?>
...
<?php switch($item->asp_f_type) { case "radio": ?>
            ...
            <select class="<?php echo w_isset_def($item->asp_f_dropdown_search, 'asp_unchecked') == 'asp_checked' ? 'asp_gochosen' : 'asp_nochosen'; ?>"
                ...
                <?php foreach($item->asp_f_dropdown_value as $dropdown): ?>
                    <?php if ( is_array($dropdown) ): ?>
                        ...
                        ?>
                        <option value="<?php echo str_replace('"', '&#34;', $dropdown[0]); ?>"<?php echo $checked; ?>><?php echo esc_html( str_replace('**', '', $dropdown[1]) ); ?></option>
                    <?php else: ?>
        ...
        <?php foreach($item->asp_f_checkboxes_value as $checkbox): ?>
            ...
            <div class="asp_option asp_option_cff">
                <div class="asp_option_inner">
                    ...
                    <label aria-hidden="true" for="aspf<?php echo $_in; ?>[<?php echo $_field_name; ?>][<?php echo $ccfi; ?>]">
    ...
    <?php case "datepicker":
        ...
        <input type="text"
               ...
               placeholder="<?php echo esc_html($item->asp_f_datepicker_placeholder); ?>"
    ...
    <?php case "slider": ?>
        ...
        <input type="hidden" class="asp_slider_hidden" id="slider-values-low-<?php echo $_in; ?>" name="aspf[<?php echo $_field_name; ?>]" value="<?php echo $_s_value; ?>">
        <?php ob_start(); ?>
        {
    ...
    <input type="hidden" class="asp_slider_hidden" id="slider-values-low-<?php echo $_in; ?>" name="aspf[<?php echo $_field_name; ?>][lower]" value="<?php echo $_s_value_low; ?>">
    <input type="hidden" class="asp_slider_hidden" id="slider-values-up-<?php echo $_in; ?>" name="aspf[<?php echo $_field_name; ?>][upper]" value="<?php echo $_s_value_up; ?>">
    <?php ob_start(); ?>
    {
